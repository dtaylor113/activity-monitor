...
## GitHub
  ### My PRs / PRs I'm Reviewing / PRs I've Approved
      | PR | Title | Author | Reviewers | My State | Checks | Created |
      ...
      Reviewers = individual reviewers with colored status badges
      My State = user's review state (pending/commented/approved/changes_requested)
      Checks = CI status + merge status
      Created = relative age (e.g., "14 days ago")
...
Write output files to `/Users/dtaylor/repos/work/AI/activity-monitor/`:
...
| PR | Title | Author | Reviewers | My State | Checks | Created |
|----|-------|--------|-----------|----------|--------|---------|
| [#454](url) | OCMUI-4330: Add Day 1 support... | zherman0 | reviewer badges | commented | passing | 14 days ago |
...
```
/Users/dtaylor/repos/work/AI/activity-monitor/ACTIVITY_MONITOR.html
```
